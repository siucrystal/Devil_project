...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/recipe/recipelayout.css">
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/recipe/recipegraph.css">
...
<form action="main" name="recipe_search_form">
	...
	<input type="text" class="input_recipe_search" name="ingredient" placeholder="재료검색" value="${ingredient}">
...
<div class="paging_region">
	...
	<c:if test="${currentPage >= 1 }">
		...
		<c:forEach var="i" begin="${start}" end="${end}">
			<li><a class="pagingbtn" href="main?pageNum=${i}&category=${category}&ingredient=${ingredient}">${i}</a></li>
		</c:forEach>
...
thirdPagingBtn.style.backgroundColor = '#ff9900';
